...
意思是說，我們希望**整個搬家的過程不要是整個都搬完然後再一次上線，而是可以找到某種方法，讓我們可以一次搬一部份就可以立刻 release 到 production。**

這樣的用意在於減少潛在的風險。因為如果我們花了兩三個星期搬動的努力，在最後一刻上線才發現哭哭不work，這樣的狀況下 user 一定會受到很大的影響。

**再者以人力的規畫和時程的預測來說，把 release 時程切小塊，有助於我們提早發現一些"要release才知道的問題"。因為像這樣的搬動過程，即使有仔細的規畫，還是充滿了不確定性。在最糟的狀況下，如果我們release第一個milestone 之後發現這一切超難搞，還來得及在付出太多時間之前想別的辦法。**

### 2. 在 release 的時候，不能有 downtime
...
也就是前面提到的"要release才會發現" 的問題。
以時程來說，切小塊 release 可以更精準的掌握整體的時程。另一方面，以 debug 的角度來說，如果真的出現了什麼可怕的問題，
